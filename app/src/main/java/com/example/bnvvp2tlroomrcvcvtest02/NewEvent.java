...
//            Toast.makeText(this, "重複事件！", Toast.LENGTH_SHORT).show();
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            if (NewEvent.this.getCurrentFocus() != null) {
                if (NewEvent.this.getCurrentFocus().getWindowToken() != null) {
                    imm.hideSoftInputFromWindow(NewEvent.this.getCurrentFocus().getWindowToken(),
